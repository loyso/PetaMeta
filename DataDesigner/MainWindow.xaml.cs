...
namespace DataDesigner
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
			FileDialogFilter = "Project files (*" + Project.ProjectExtension() + ")|*" + Project.ProjectExtension() + "|All files (*.*)|*.*";
		...
		private void New_Executed(object sender, ExecutedRoutedEventArgs e)
		{
			...
			Project.gui.game.name = "Game";
			Project.gui.mainMenu.name = "MainMenu";
